...
def index():
    ...
    sidebar = Div(
        ...
        Div(cls="hidden lg:flex items-center justify-center py-6")(
            H1(
                A('Mi empresa', hx_get='/home', hx_target="#main-content", onclick="hideSidebar()"),
                cls=(TextT.lg, TextT.bold)
            )
        ),
    ...
    contenido_principal = Div(cls="pt-4 lg:pt-0 ml-0 lg:ml-64", id="main-content")(
        DivFullySpaced(
            ...
            DivRAligned(
                DivHStacked(
                    Input("Buscar..."),
                    Button("Nuevo", cls=ButtonT.primary),
                    Button("...", cls=ButtonT.secondary),
                ),
                cls="py-2 px-4 lg:py-4 lg:pr-60 bg-blue-200"
            ),
            cls="bg-red-200 lg:pl-20 lg:pr-20 px-2"
        ),
